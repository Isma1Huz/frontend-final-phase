  ...
  return (
    <div className="App">
      ...
      <div className='ingredients'>
        ...
        <h5 className='rating'><b>Rating</b></h5>
        <ol className='rates'>
        ...
        <h5 className='rating'><b>Comments</b></h5>
        ...
        <h5 className='rating'><b>Share Recipe</b></h5>
        <div className='share'>
          <a href='https://www.facebook.com/'><img src={facebook} alt='Facebook'/></a>
          <a href='https://twitter.com/'><img src={twitter} alt='Twitter'/></a>
          <a href='https://www.pinterest.com/'><img src={pintrest}  alt='Pintrest'/></a>
